...
var testTotal = parseInt(0);
var testFails = parseInt(0);
var testSkips = parseInt(0);
var testErrors = parseInt(0);
var testTime = parseFloat(0);
...
function parseXmlFromFile(fileName) {
  try {
    ...
    testTotal = testTotal + parseInt(xmlDoc.attr.tests);
    testFails = testFails + parseInt(xmlDoc.attr.failures);
    testSkips = testSkips + parseInt(xmlDoc.attr.skipped);
    testErrors = testErrors + parseInt(xmlDoc.attr.errors);
    testTime = testTime + parseFloat(xmlDoc.attr.time);
